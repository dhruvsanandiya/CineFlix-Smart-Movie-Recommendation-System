...
#        check = difflib.get_close_matches(m_name,all_titles,cutout=0.50,n=1)
        if m_name not in all_titles:
            return flask.render_template('notFound.html', name=m_name, all_titles=all_titles)
        else:
            ...
            # Zip the data into a single iterable
            movie_data = zip(names, homepage, releaseDate)
            
            # Pass the zipped movie data to the template
